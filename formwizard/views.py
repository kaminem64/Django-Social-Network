...
from solutioner.formwizard.storage import get_storage
from solutioner.formwizard.storage.exceptions import NoFileStorageConfigured
from solutioner.formwizard.forms import ManagementForm
...
class WizardView(TemplateView):
    ...
    def render_done(self, form, **kwargs):
        ...
        final_check_list = self.get_form_list()
        del final_check_list['1']
        self.form_list = final_check_list
