...
HAYSTACK_XAPIAN_PATH = '/home/kaminem64_test/xapian-index-solutioner'
CACHES = {
    'default': {
        'BACKEND': 'solutioner.memcached.MemcachedCache',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'solutioner_beta3',                      # Or path to database file if using sqlite3.
        'USER': 'kaminem64',                      # Not used with sqlite3.
        'PASSWORD': 'linux116',                  # Not used with sqlite3.
        'HOST': 'database.solutioner.net',                      # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_ROOT = '/home/kaminem64_test/static.solutioner.net/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = 'http://static.solutioner.net/media'

# Absolute path to the directory static files should be collected to.
# Don't put anything in this directory yourself; store your static files
# in apps' "static/" subdirectories and in STATICFILES_DIRS.
# Example: "/home/media/media.lawrence.com/static/"
STATIC_ROOT = '/home/kaminem64_test/static.solutioner.net/media/'

# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
STATIC_URL = 'http://static.solutioner.net/media'
